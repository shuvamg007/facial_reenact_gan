...
if __name__ == '__main__':
    ...
    parser.add_argument('--ip_folder', dest='input_folder', type=str, help='Folder to import model from')
    parser.add_argument('--op_folder', dest='output_folder', type=str, help='Folder to export model to')
